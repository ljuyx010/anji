/* This file is created by MySQLReback 2018-06-18 10:38:27 */
 /* 创建表结构 `lj_admin` */
 ...
 /* 插入数据 `lj_admin` */
 INSERT INTO `lj_admin` VALUES ('1','ljuyx','e10adc3949ba59abbe56e057f20f883e','李俊','1528896654',''),('2','testuser','e10adc3949ba59abbe56e057f20f883e','测试用户2','1528798637',''),('3','testuser1','e10adc3949ba59abbe56e057f20f883e','测试用户1','1528805601','');/* MySQLReback Separation */
 /* 创建表结构 `lj_article` */
 ...
 /* 插入数据 `lj_article` */
 INSERT INTO `lj_article` VALUES ('1','文章内容管理测试','阿斯顿发','按时噶事嘎嘎嘎','撒发嘎嘎三个阿斯钢阿斯钢暗关','1528732800','4','0','1','/Upload/image/2018-06-04/5b150d82b37a6.jpg','周博'),('2','发生发生了法法师','','们恐怕是开放老妈说佛叫司法局','们恐怕是开放老妈说佛叫司法局','1528279154','0','0','0','','');/* MySQLReback Separation */
 /* 创建表结构 `lj_auth_group` */
 ...
 INSERT INTO `lj_auth_group_access` VALUES ('1','1'),('2','2'),('3','2');/* MySQLReback Separation */
 /* 创建表结构 `lj_auth_rule` */
 ...
 DROP TABLE IF EXISTS `lj_car`;/* MySQLReback Separation */ CREATE TABLE `lj_car` (
  ...
  `ktime` int(10) DEFAULT NULL COMMENT '维修完成日期',
 ...
 /* 插入数据 `lj_session` */
 INSERT INTO `lj_session` VALUES ('0iqs6gpqfqn370efirlivn02m3','1529296704','');/* MySQLReback Separation */
 /* 创建表结构 `lj_shen` */
 ...
 DROP TABLE IF EXISTS `lj_user`;/* MySQLReback Separation */ CREATE TABLE `lj_user` (
  ...
  `nickname` varchar(10) NOT NULL COMMENT '微信昵称',
  `tel` char(11) DEFAULT NULL COMMENT '电话',
  `mark` text COMMENT '备注',
  `photo` varchar(40) DEFAULT NULL COMMENT '微信头像',
  `regtime` int(10) NOT NULL COMMENT '注册日期',
  `logintime` int(10) NOT NULL COMMENT '登录日期',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;/* MySQLReback Separation */
 /* 创建表结构 `lj_wage` */
