...
<body class="gray-bg">
    ...
    <script>
    var url1="<?php echo U('Outfit/updatas');?>";
    var str="";
    jQuery(document).ready(function() {
        ...
        "sAjaxSource": "<?php echo U('Outfit/car',array('f'=>1));?>",
        "aoColumns": [            
            {"mData": "id", "bSortable": true},
            {"mData": "carnum", "bSortable": false},
            {"mData": "zl","bSortable": false,"mRender": function (obj) {
            ...
            {"mData": "sums","bSortable": false},
            {"mData": "carnum","bSortable": false,"mRender": function(data) {
                return "<a href='"+url1+"/id/"+ data +"' class='btn btn-info btn-sm'><i class='fa fa-edit'></i> 管理 </a>";
                }
            }
        ]
        });
