                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" width="64" src="/WEB/Website/public/img/a10.jpg" /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="<?php echo ('Admin/mindfiy');?>">修改密码</a>
                                </li>
                                <li class="divider"></li>
                    ...
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="http://www.zi-han.net/theme/hplus/search_results.html">
                            <div class="form-group">
                                <input type="text" placeholder="请输入车牌号…" class="form-control" name="top-search" id="top-search">
                            </div>
                        </form>
                    </div>
