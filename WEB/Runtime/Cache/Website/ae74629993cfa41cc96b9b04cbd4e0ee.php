                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Car/diaodu');?>">车辆调度</a>
                            </li>                           
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="<?php echo U('Orders/tongji');?>">订单统计</a>
                            </li>
                        </ul>
                    </li>
                    <li>
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="<?php echo U('Finacal/fap');?>">发票管理</a>
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-wrench"></i> <span class="nav-label">机务管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                             <li><a class="J_menuItem" href="<?php echo U('Outfit/index');?>">设备购入</a></li>
                            <li><a class="J_menuItem" href="<?php echo U('Outfit/car');?>">随车设备</a></li>
                            <li><a class="J_menuItem" href="<?php echo U('After/oilist');?>">加油登记</a></li>
                            <li><a class="J_menuItem" href="<?php echo U('After/weixiu');?>">维修登记</a></li>                                                  
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cubes"></i> <span class="nav-label">安全管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<?php echo U('After/dingd');?>">完成订单</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('After/tousu');?>">投诉违章</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('After/nianshen');?>">年审保险</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('After/safe');?>">事故登记</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('After/tongj');?>">事故统计</a></li>   
                        </ul>
                    </li>     
