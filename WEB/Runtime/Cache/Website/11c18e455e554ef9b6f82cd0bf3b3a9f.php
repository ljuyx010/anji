            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>设置完成订单</h5> 
                        <div class="gohome">
                        <a class="animated bounceInUp" href="<?php echo U('After/dingd');?>" title="返回"><i class="fa fa-mail-reply-all"></i></a>
                        </div>                 
                    </div>
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('After/jsuan');?>" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" >
                                    <p class="form-control-static"><?php echo ($v["carnum"]); ?></p>
                                </div>
                            </div> 
                            </if>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">                                
                                    <p class="form-control-static"><?php echo ($v["edr"]); ?></p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">实际里程</label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="mileage" value="<?php echo ($v["mileage"]); ?>">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">出行天数</label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="d" value="">
                                        <span class="input-group-addon">天</span>                                        
                                    </div>
                                    <span class="help-block m-b-none">实际出行天数,不足一天的就按1天算。</span>
                                     <input type="hidden" name="id" value="<?php echo ($v["id"]); ?>"></input>
                                    <input type="hidden" name="cid" value="<?php echo ($v["cid"]); ?>"></input>
                                </div>                                
                            </div>                                                                              
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
