...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="<?php echo U('After/addn');?>" class="btn btn-primary "><i class="fa fa-plus"></i> 添加年审保险</a>
                        </div>
    ...
    <script>
      var url1="<?php echo U('After/updatan');?>";
    var url2="<?php echo U('After/deleten');?>";
