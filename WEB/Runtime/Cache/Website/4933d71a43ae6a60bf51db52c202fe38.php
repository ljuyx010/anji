                        ...
                        <form method="post" action="<?php echo U('Orders/runaddx');?>" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php if(is_array($class)): foreach($class as $key=>$c): ?><option <?php if($orders['cid'] == $c['id']): ?>selected<?php endif; ?> value="<?php echo ($c["id"]); ?>|<?php echo ($c["classname"]); ?>"><?php echo ($c["classname"]); ?></option><?php endforeach; endif; ?>                                   
                                    </select>
                                </div>
                            </div>                         
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="suggestId" name="sdr" value="<?php echo ($orders["sdr"]); ?>">
                                    <div id="searchResultPanel" style="border:1px solid #C0C0C0;width:100%;display: none;"></div>
                                </div>
                                <label class="col-sm-2 control-label">目的地</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="suggestId2" name="edr" value="<?php echo ($orders["edr"]); ?>">
