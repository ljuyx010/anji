...
<head>
    ...
    <link rel="stylesheet" href="/public/jump/msgbox.css" />
    <link rel="stylesheet" href="/public/jump/sweetalert.css" />
    ...
    <div class="system-message">
      <!-- 成功提示 -->
        <?php if(isset($message)) {?>
            ...
            </div><div class="sa-icon sa-custom" style="display: none; width: 80px; height: 80px; background-image: url(/public/jump/thumbs-up.jpg);"></div><h2><?php echo(strip_tags($message));?></h2>
